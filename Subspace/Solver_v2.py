...
class his_manager:
    def __init__(self):
        ...
        self.n_model_implicit = 0 # int; number of implicit model constructing step
...
# update parameter   
    ...
    def check_stop(self):
        ...
        # stop criterion for rosenbrock
        if self.prob.prob_name == 'self constructed rosenbrock' and self.y_current < 1e-9:
            self.his.x_star = self.x_current
            self.his.y_star = self.y_current
    ...
    def display_result(self):
        ...
        print('number of implicit model constructing step: ', res.n_model_implicit)
